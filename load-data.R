...
loadData <- function() {
    ...
    # Found with
    #  grep -n1 '^1/2/2007' household_power_consumption.txt | head -n1
    #  grep -n1 '^3/2/2007' household_power_consumption.txt | head -n1
    # TODO: convert lookup to r-code
    t <- read.table(f, sep=";", header = FALSE, 
                    na.strings = "?",
